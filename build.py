...
def build_all():
    ...
    os.system("i686-elf-gcc -g -ffreestanding -I kernel/include/ -w -Wno-implicit-function-declaration -c kernel/src/sys/gdt.c -o bin/kernel/gdt.o")
    os.system("i686-elf-gcc -g -ffreestanding -I kernel/include/ -w -Wno-implicit-function-declaration -c kernel/src/sys/idt.c -o bin/kernel/idt.o")
